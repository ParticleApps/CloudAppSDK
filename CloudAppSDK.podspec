Pod::Spec.new do |spec|
  ...
  spec.description           = 'Supports all API features documented here http://developer.getcloudapp.com. Eventually this description will be copied from the README.'
  spec.homepage              = 'https://github.com/ParticleApps/CloudAppSDK'
  spec.license               = { :type => 'Apache License, Version 2.0' }
  spec.author                = { 'Rocco Del Priore' => 'rocco@particleapps.co' }
  spec.source                = { :git => 'https://github.com/ParticleApps/CloudAppSDK.git', :tag => "v#{spec.version}" }
